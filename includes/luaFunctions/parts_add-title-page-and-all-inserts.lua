function plugindef()
    ...
    finaleplugin.CategoryTags = "add part inserts and title page"
    return "Parts - Add Inserts and Title Page", "Parts - Add Inserts and Title Page", "Add Part Inserts and Title Page"
end
...
inserts_everythingElse = {
  ...
  {"^font(Times New Roman)^size(14)^nfx(65)^partname()", "left", 144, -86, 2, 998},
